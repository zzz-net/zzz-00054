...
**批次名称**: test_batch_e2e
**批次 ID**: 20260615_120027
**创建时间**: 2026-06-15T12:00:27.562700
**规则版本**: 1.0.0
**导出时间**: 2026-06-15 12:01:42

## 📊 统计概览

- **总事件数**: 45
- **时间范围**: 2026-06-14T09:15:00 ~ 2026-06-15T12:00:29.853742
- **时间缺口数**: 3
- **阶段数**: 0
...
| 轮次 | 触发原因 | 事件数(前→后) | 导入文件(前→后) | 规则版本 | 时间 |
|-----|---------|--------------|----------------|---------|------|
| 8 | 导入数据 | 34→45(+11) | 3→3(0) | 1.0.0 | 2026-06-15 12:00:30 |
| 7 | 导入数据 | 34→34(0) | 2→3(+1) | 1.0.0 | 2026-06-15 12:00:29 |
| 6 | 导入数据 | 34→34(0) | 2→2(0) | 1.0.0 | 2026-06-15 12:00:29 |
| 5 | 导入数据 | 21→34(+13) | 2→2(0) | 1.0.0 | 2026-06-15 12:00:29 |
| 4 | 导入数据 | 21→21(0) | 1→2(+1) | 1.0.0 | 2026-06-15 12:00:29 |
| 3 | 导入数据 | 21→21(0) | 1→1(0) | 1.0.0 | 2026-06-15 12:00:28 |
| 2 | 导入数据 | 0→21(+21) | 1→1(0) | 1.0.0 | 2026-06-15 12:00:28 |
| 1 | 导入数据 | 0→0(0) | 0→1(+1) | 1.0.0 | 2026-06-15 12:00:28 |

### 主要变更摘要

- 事件数变化: +11
- 新增导入: notes.json (备注(JSON), 11事件)
- 事件数变化: +13
- 新增导入: alerts.csv (告警(CSV), 16事件)
- 事件数变化: +21
- 新增导入: app.log (日志(LOG), 23事件)
...
| 3 | 2026-06-14 10:35:00 | 2026-06-15 12:00:29 | 25h25m29s |
